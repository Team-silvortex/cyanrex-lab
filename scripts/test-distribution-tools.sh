...
assert_contains "$ROOT_DIR/scripts/live-kernel-smoke.sh" 'RELEASE_TOOL=(cyanrex-release)'
assert_contains "$ROOT_DIR/scripts/live-kernel-smoke.sh" 'smoke live-kernel'
