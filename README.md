...
```bash
./scripts/package-distribution.sh --version 0.4.3
```

This produces:
- `dist/cyanrex-lab-0.4.3-<timestamp>.tar.gz`
- `dist/cyanrex-lab-0.4.3-<timestamp>.tar.gz.sha256`
...
and clean/dirty state, matching annotated version Tag when present, image references/content IDs/build
