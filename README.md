...
```bash
./scripts/package-distribution.sh --version 0.4.2
```

This produces:
- `dist/cyanrex-lab-0.4.2-<timestamp>.tar.gz`
- `dist/cyanrex-lab-0.4.2-<timestamp>.tar.gz.sha256`
