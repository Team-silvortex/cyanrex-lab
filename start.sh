...
start_local_stack() {
  ...
  (
    sudo env \
    ENGINE_HOST=0.0.0.0 ENGINE_PORT="${CYANREX_ENGINE_PORT}" \
    ...
    CYANREX_TEACHER_USERNAMES="${CYANREX_TEACHER_USERNAMES:-}" CYANREX_ADMIN_USERNAMES="${CYANREX_ADMIN_USERNAMES:-}" \
    CYANREX_CLASSROOM_PUBLIC_URL="${CYANREX_CLASSROOM_PUBLIC_URL:-}" CYANREX_CLASSROOM_ID="${CYANREX_CLASSROOM_ID:-}" CYANREX_CLASSROOM_NAME="${CYANREX_CLASSROOM_NAME:-}" \
    CYANREX_ADMIN_PASSWORD="$CYANREX_ADMIN_PASSWORD" \
    CYANREX_ADMIN_TOTP_SECRET="$CYANREX_ADMIN_TOTP_SECRET" \
    CYANREX_ALLOW_REGISTRATION="${CYANREX_ALLOW_REGISTRATION:-false}" CYANREX_ALLOW_TOTP_BOOTSTRAP="${CYANREX_ALLOW_TOTP_BOOTSTRAP:-false}" \
    CYANREX_CORS_ORIGINS="${CYANREX_CORS_ORIGINS:-}" CYANREX_SECURE_COOKIES="${CYANREX_SECURE_COOKIES:-false}" \
  ...
  (
    ...
    NEXT_PUBLIC_ENGINE_URL="${NEXT_PUBLIC_ENGINE_URL:-http://localhost:${CYANREX_ENGINE_PORT}}" \
